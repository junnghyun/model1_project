...
public class AdminPrdVO {
	...
	public AdminPrdVO(int product_id, int total_weight, int calories, int sugar, int protein, int saturated_fat,
	...
	public void setProduct_img(String product_image) {
		this.product_img = product_image;
	}
	...
	public String toString() {
		return "UserPrdVO [product_id=" + product_id + ", total_weight=" + total_weight + ", calories=" + calories
				...
				+ ", product_name=" + product_name + ", product_type=" + product_type + ", product_image="
