...
<body bgcolor="#F7F0DA">
    ...
    <div align="center">
        ...
        <div class="store-container">
            <!-- 매장 검색 섹션 -->
            <div class="section2" style="position: relative; width: 600px;">
                <ul>
                    <li>
                        <img src="truetrue/common/images/trz.png" style="width: 100%; display: block; filter: brightness(0.5);">
                        <div class="store_find" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); z-index: 10;">
            ...
            <!-- 매장 안내 섹션 -->
            <div class="new_div" style="text-align: center; width: 390px; height: 270px; background-color: #333333">
                <a href="truetrue/store/store_list.jsp">
                    <img src="truetrue/common/images/market_info.png" width="390px" height="270px" style="display: block; filter: brightness(0.8);">
                </a>
