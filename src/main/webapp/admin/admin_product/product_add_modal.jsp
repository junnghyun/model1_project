...
<div class="modal-overlay">
    <div class="modal-content shadow-xl max-w-3xl mx-auto">
        ...
        <form class="p-4 space-y-4" id="addProductForm">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="input-group">
                    <label for="product_id" class="block text-sm font-medium text-gray-700 mb-1">제품 ID</label>
                    <input type="text" id="product_id" name="product_id" class="w-full px-2 py-1 text-sm bg-gray-100 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" value="" readonly>
                </div>
                <div class="input-group">
