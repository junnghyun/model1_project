<%@page import="kr.co.truetrue.user.cart.LoginDAO"%>
...
href="http://192.168.10.229/jsp_prj/common/images/paka.jpg">
<link rel="stylesheet" type="text/css"
href="http://192.168.10.229/jsp_prj/common/CSS/main_20240911.css">
<!-- bootstrap CDN -->
...
%>
        <script type="text/javascript">
            ...
            window.location.href = "cart.jsp"; // 성공 시 main_page.jsp로 이동
        </script>
<%
    } else {
%>
